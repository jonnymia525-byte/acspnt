...
const FAQS = [
  ...
  { q: "How do I deposit?", a: "Dashboard > Deposit. Choose Crypto, PayPal, Stripe, or Manual. Min $5." },
  { q: "Return policy?", a: "Open a dispute within 48 hours if the account is invalid. Admin team reviews within 24h." },
  { q: "Payment methods?", a: "Crypto (BTC, USDT, ETH, LTC, TRX), PayPal, Stripe, manual top-up." },
  { q: "How to become a seller?", a: "Click Become a Seller, fill details, describe products. Reviewed within 24-48h." },
  { q: "Commission?", a: "40% on all sales. Store price = vendor price x 1.4." },
